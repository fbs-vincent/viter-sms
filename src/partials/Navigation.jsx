  ...
  `}
      >
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          {/* <li>
            <a href="./dashboard.html" className="navItem active">
              <span>
                {" "}
          ...
          <li>
            <a href="./students.html" className="navItem">
              <span>
          ...
          <li>
            <a href="./teachers.html" className="navItem">
              <span>
          ...
          <li>
            <a href="./classNamees.html" className="navItem">
              <span>
          ...
          <li>
            <a href="./settings.html" className="navItem">
              <span>
